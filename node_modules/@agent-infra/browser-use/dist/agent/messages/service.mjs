...
const logger = (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_e798cd09__.createLogger)('MessageManager');
class MessageManager {
    initTaskMessages(systemMessage, task, messageContext) {
        ...
        if (messageContext && messageContext.length > 0) {
            const contextMessage = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
        ...
        if (this.sensitiveData) {
            ...
            const infoMessage = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
                content: `${info}\nTo use them, write <secret>the placeholder name</secret>`
            });
            this.addMessageWithTokens(infoMessage);
        }
        const placeholderMessage = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
        ...
        const toolCalls = [
            {
                ...
                parameters: (0, __WEBPACK_EXTERNAL_MODULE_zod_to_json_schema_a1d75503__.zodToJsonSchema)(__WEBPACK_EXTERNAL_MODULE_zod__.z.object({
                    current_state: __WEBPACK_EXTERNAL_MODULE_zod__.z.object({
                    ...
                    action: __WEBPACK_EXTERNAL_MODULE_zod__.z.array(__WEBPACK_EXTERNAL_MODULE_zod__.z.object({
                        click_element: __WEBPACK_EXTERNAL_MODULE_zod__.z.object({
        ...
        const exampleToolCall = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.AIMessage({
        ...
        const historyStartMessage = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
    ...
    static taskInstructions(task) {
        ...
        return new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
            content
        });
    }
    length() {
    ...
    addNewTask(newTask) {
        ...
        const msg = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
            content
        });
    ...
    addPlan(plan, position) {
        if (plan) {
            const msg = new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.AIMessage({
                content: plan
            });
    ...
    convertMessagesForNonFunctionCallingModels(inputMessages) {
        return inputMessages.map((message)=>{
            if (message instanceof __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage || message instanceof __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.SystemMessage) return message;
            if (message instanceof __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.ToolMessage) return new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.HumanMessage({
                content: message.content
            });
            if (message instanceof __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.AIMessage) {
                if ('tool_calls' in message) {
                    const toolCalls = JSON.stringify(message.tool_calls);
                    return new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.AIMessage({
                        content: toolCalls
                    });
                }
                return message;
    ...
    constructor({ maxInputTokens = 128000, estimatedCharactersPerToken = 3, imageTokens = 800, sensitiveData } = {}){
        ...
        this.history = new __WEBPACK_EXTERNAL_MODULE__views_mjs_50feee0f__.MessageHistory();
