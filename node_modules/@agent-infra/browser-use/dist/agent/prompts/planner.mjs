...
class PlannerPrompt extends __WEBPACK_EXTERNAL_MODULE__base_mjs_f55655df__.BasePrompt {
    getSystemMessage() {
        return new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.SystemMessage(`You are a helpful assistant.
