...
class ValidatorPrompt extends external_base_js_namespaceObject.BasePrompt {
    tasksToValidate() {
...
`;
    ...
    getSystemMessage() {
        return new messages_namespaceObject.SystemMessage(`You are a validator of an agent who interacts with a browser.
YOUR ROLE:
