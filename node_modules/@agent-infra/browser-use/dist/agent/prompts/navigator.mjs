...
class NavigatorPrompt extends __WEBPACK_EXTERNAL_MODULE__base_mjs_f55655df__.BasePrompt {
    importantRules() {
        const text = `
...
Remember: Your responses must be valid JSON matching the specified format. Each action in the sequence must be valid.`;
        return new __WEBPACK_EXTERNAL_MODULE__langchain_core_messages_57fab301__.SystemMessage(AGENT_PROMPT);
    }
    async getUserMessage(context) {
        return await this.buildBrowserStateUserMessage(context);
    }
    constructor(maxActionsPerStep = 10){
        super(), _define_property(this, "maxActionsPerStep", void 0), _define_property(this, "default_action_description", void 0), this.maxActionsPerStep = maxActionsPerStep, this.default_action_description = "A placeholder action description";
    }
}
export { NavigatorPrompt };
