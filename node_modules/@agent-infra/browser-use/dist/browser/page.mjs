...
import * as __WEBPACK_EXTERNAL_MODULE__dom_service_mjs_4e040865__ from "../dom/service.mjs";
import * as __WEBPACK_EXTERNAL_MODULE__dom_views_mjs_71251f2f__ from "../dom/views.mjs";
...
const logger = (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_2b03add0__.createLogger)('Page');
function build_initial_state(url, title) {
    return {
        elementTree: new __WEBPACK_EXTERNAL_MODULE__dom_views_mjs_71251f2f__.DOMElementNode({
            tagName: 'root',
            isVisible: true,
            parent: null,
            xpath: '',
...
class Page {
    ...
    async attachPuppeteer() {
        ...
        const localBrowser = new __WEBPACK_EXTERNAL_MODULE__agent_infra_browser_45fd5ecc__.LocalBrowser();
        ...
        await this.executeScript(page, {
            contents: [
                (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_2b03add0__.getBuildDomTreeScript)()
            ]
        });
    ...
    async removeHighlight() {
        if (this._config.highlightElements && this._validWebPage) await (0, __WEBPACK_EXTERNAL_MODULE__dom_service_mjs_4e040865__.removeHighlights)(this._puppeteerPage);
    }
    async getClickableElements(focusElement) {
        if (!this._validWebPage) return null;
        return (0, __WEBPACK_EXTERNAL_MODULE__dom_service_mjs_4e040865__.getClickableElements)(this._puppeteerPage, this._config.highlightElements, focusElement, this._config.viewportExpansion);
    }
    async getScrollInfo() {
        ...
        return (0, __WEBPACK_EXTERNAL_MODULE__dom_service_mjs_4e040865__.getScrollInfo)(this._puppeteerPage);
    }
    async getContent() {
    ...
    async getMarkdownContent(selector) {
        if (!this._validWebPage) return '';
        return (0, __WEBPACK_EXTERNAL_MODULE__dom_service_mjs_4e040865__.getMarkdownContent)(this._puppeteerPage, selector);
    }
    async getReadabilityContent() {
        if (!this._validWebPage) return null;
        return (0, __WEBPACK_EXTERNAL_MODULE__dom_service_mjs_4e040865__.getReadabilityContent)(this._puppeteerPage);
    }
    async getState() {
    ...
    async locateElement(element) {
        return await (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_25ece7d1__.locateElement)(this._puppeteerPage, element, this._config);
    }
    ...
    async _scrollIntoViewIfNeeded(element, timeout = 2500) {
        await (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_25ece7d1__.scrollIntoViewIfNeeded)(element, timeout);
    }
    ...
    async waitForPageAndFramesLoad(timeoutOverwrite) {
        await (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_25ece7d1__.waitForPageAndFramesLoad)(this._puppeteerPage, timeoutOverwrite, this._config);
    }
...
export { build_initial_state, Page as default };
