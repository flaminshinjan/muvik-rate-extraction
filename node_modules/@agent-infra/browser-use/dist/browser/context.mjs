...
import * as __WEBPACK_EXTERNAL_MODULE__page_mjs_e8e8da87__ from "./page.mjs";
...
const logger = (0, __WEBPACK_EXTERNAL_MODULE__utils_mjs_2b03add0__.createLogger)('BrowserContext');
class BrowserContext {
    ...
    async _getOrCreatePage(url, forceUpdate = false) {
        ...
        return new __WEBPACK_EXTERNAL_MODULE__page_mjs_e8e8da87__["default"](url || '', '', this._config);
    }
    async cleanup() {
    ...
    async getState() {
        var _currentPage_browser;
        const currentPage = await this.getCurrentPage();
        const pageState = currentPage ? await currentPage.getState() : (0, __WEBPACK_EXTERNAL_MODULE__page_mjs_e8e8da87__.build_initial_state)();
        const pages = await (null === (_currentPage_browser = currentPage.browser) || void 0 === _currentPage_browser ? void 0 : _currentPage_browser.pages());
...
export { BrowserContext as default };
